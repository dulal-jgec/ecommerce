...
import { ChevronDownIcon, FunnelIcon, PlusIcon, MinusIcon } from '@heroicons/react/20/solid'
...
export default function Product() {
  ...
  const {
    ...
    selectedSort,
    setSelectedSort,
  } = useFilter(mens_kurta, sortOptions[0])
    ...
    <div className="bg-[linear-gradient(to_bottom,var(--light-bg),#ecfdf5)]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end border-b pb-6 gap-4">
          <div>
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Men's Kurtas</h1>
            <p className="text-gray-600 mt-1">{filteredProducts.length} premium styles</p>
          </div>
          ...
          <div className="hidden lg:block w-72">
            <div className="sticky top-6 bg-white border rounded-3xl p-6 shadow-md">
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={clearAllFilters} className="text-sm text-red-500">
                  Clear All
                </button>
              </div>
