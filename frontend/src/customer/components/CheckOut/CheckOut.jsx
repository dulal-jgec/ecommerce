...
const Checkout = () => {
  ...
  const handleAddressSubmit = (addressData, shippingMethod) => {
    setFormData(prev => ({
      ...prev,
      address: addressData,
  ...
  const handlePaymentSubmit = (paymentData) => {
    ...
    console.log('Order submitted:', { ...formData, paymentMethod: paymentData });
  ...
  const calculateTotal = () => {
    // This should come from your cart context/state
   ...
   <div className="bg-[linear-gradient(to_bottom,var(--light-bg),#ecfdf5)]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Complete your purchase with confidence</p>
        </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-4">
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                ...
                <button className="w-full py-2 text-indigo-600 font-medium text-sm border border-indigo-200 rounded-xl hover:bg-indigo-50 transition-colors">
                  Contact Support
                </button>
              </div>
            </div>
